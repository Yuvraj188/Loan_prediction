...
image = Image.open("Loan_prediction/Loan-approval-prediction-using-machine-learning-main/img/funding.png")
...
loaded_model_LR = joblib.load(open("C:\\Users\\Yuvraj Singh Rathore\\Desktop\\project\\Loan-approval-prediction-using-machine-learning-main\\loan_predition_model_LR.pkl", 'rb'))
loaded_model_RF = joblib.load(open("C:\\Users\Yuvraj Singh Rathore\\Desktop\\project\\Loan-approval-prediction-using-machine-learning-main\\loan_predition_model_RF", 'rb'))
